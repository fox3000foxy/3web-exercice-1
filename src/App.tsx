    ...
    <Router>
      <Layout currentUser={currentUser} setCurrentUser={setCurrentUser} users={data.utilisateurs}>
        <Routes>
          ...
          <Route 
            path="/carte-fidelite" 
            element={<CarteFidelite data={data} currentUser={currentUser} setCurrentUser={setCurrentUser} />} 
          />
          <Route 
            path="/utilisateurs" 
            element={<Utilisateurs data={data} currentUser={currentUser} />} 
          />
          <Route 
            path="/produits" 
            element={<Produits data={data} currentUser={currentUser} />} 
          />
          <Route 
            path="/commandes" 
            element={<Commandes data={data} currentUser={currentUser} />} 
          />
        </Routes>
      </Layout>
    </Router>
