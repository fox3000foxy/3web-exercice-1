        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <StatsCard
                    ...
                    value={`${statistiques.totalVentes.toFixed(2)} €`}
                    icon="euro-sign"
                    color="green"
                ...
                <StatsCard
                    title="Bénéfice"
                    value={`${statistiques.benefice.toFixed(2)} €`}
                    icon="chart-line"
                    color="blue"
                ...
                <StatsCard
                    ...
                    value={statistiques.nombreCommandes}
                    icon="shopping-cart"
                    color="orange"
                />
                <StatsCard
                    title="Produits Disponibles"
                    value={statistiques.nombreProduits}
                    icon="box"
                    color="blue"
                />
                <StatsCard
                    title="Heure Moyenne"
                    value={statistiques.heureMoyenneCommande}
                    icon="clock"
                    color="purple"
                />
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <ResponsiveContainer width="100%" height={300}>
                        <PieChart>
                            <Pie
                                data={repartitionPaiements as any}
                                cx="50%"
                                cy="50%"
                                labelLine={false}
                                label={(entry: any) => `${entry.type}: ${entry.pourcentage}%`}
                                outerRadius={100}
                                fill="#8884d8"
                                dataKey="pourcentage"
                            >
                        ...
                        {topClients.parCommandes.map((client, index) => (
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    <div className={`w-8 h-8 rounded-full flex items-center justify-center font-bold text-white text-sm ${index === 0 ? 'bg-gradient-to-br from-yellow-500 to-orange-600' :
