                ...
                <div className="mb-8">
                    <div className="w-full bg-gray-200 rounded-full h-3">
                        <div
                            ...
                            style={{ width: `${(userPoints / nombreTampons) * 100}%` }}
                        />
                    </div>
                    <p className="text-sm text-gray-500 mt-2">
                        {userPoints === nombreTampons ? 'Carte complète ! 🎉' : `Plus que ${nombreTampons - userPoints} tampons`}
                    </p>
                </div>
                ...
                <div className="grid grid-cols-4 gap-4 mb-6">
                    {Array.from({ length: nombreTampons }).map((_, index) => (
                        <button
                            ...
                            className={`aspect-square rounded-xl flex flex-col items-center justify-center transition-all transform hover:scale-105 border-2 ${index < userPoints
                                    ? 'bg-gradient-to-br from-purple-500 to-purple-600 text-white shadow-md border-purple-600'
                                    : 'bg-white text-gray-400 hover:bg-gray-50 border-gray-300 border-dashed'
                                }`}
                        >
                    ...
                    {activeProduits.map((produit) => (
                        ...
                        >
                            <div className="flex items-start justify-between mb-3">
                                ...
                                <span className="bg-gradient-to-r from-blue-500 to-blue-600 text-white px-2.5 py-1 rounded-full text-xs font-bold shadow-sm">
                                    {produit.prix.toFixed(2)} €
                                </span>
                            </div>
                            <button
                                onClick={() => setSelectedProduct(produit)}
                                className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-2.5 px-4 rounded-lg transition-colors text-sm shadow-sm"
                            >
                    ...
                    <div className="bg-white rounded-2xl p-8 max-w-md w-full shadow-2xl relative animate-slide-in">
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-gray-600 mb-6 leading-relaxed">
                                Vous avez collecté tous les tampons ! Vous pouvez maintenant choisir un produit gratuit dans notre boutique.
                            </p>
                            <button
                                onClick={handleClaimReward}
                                className="bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white font-bold py-3 px-8 rounded-lg transition-all shadow-md hover:shadow-lg"
                            >
                                <i className="fas fa-gift mr-2"></i>
                                Choisir mon cadeau
                            </button>
                    ...
                    <div className="bg-white rounded-2xl p-8 max-w-md w-full shadow-2xl relative animate-slide-in">
                        ...
                        <div className="text-center">
                            ...
                            <div className="space-y-3">
                                ...
                                <button
                                    onClick={() => setSelectedProduct(null)}
                                    className="w-full bg-white border-2 border-gray-300 hover:bg-gray-50 text-gray-700 font-semibold py-3 px-6 rounded-lg transition-colors"
                                >
                                    Annuler
                                </button>
                            </div>
